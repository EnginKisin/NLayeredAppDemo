...
namespace Northwind.WebFormsUI
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            // _productService = new ProductManager(new EfProductDal());//Dependency ınjection ve ıoC container kullanmadan.
        ...
        private void tbxProductName_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dgwProduct.DataSource = _productService.GetProductsByProduct(tbxProductName.Text);
            }
            else
            {
                LoadProducts();
